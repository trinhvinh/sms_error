		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">				
				...
				<div class="box-register">
					...
					<form class="form-register" id="">
						<fieldset>
							<legend> Register to your account </legend>
							<p>Please enter your information to register</p>
							<div class="form-group">
								<span class="input-icon">
									<input type="text" class="form-control" name="email" id="ajaxlogin_email" placeholder="Email">
							...
							<div class="form-group form-actions">
								<span class="input-icon">
									<input type="password" class="form-control password" name="password_again" id="ajaxlogin_password" placeholder="Password repeat">
									<i class="fa fa-lock"></i>									
								</span>
							</div>
