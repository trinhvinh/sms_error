...
<div id="app">
			<!--start sidebar -->
			<%@ include file="/jsplib/interface/sidebar2.jsp"%>
			<!-- end sidebar -->
			<div class="app-content">
				<!-- start: TOP NAVBAR -->
				<%@ include file="/jsplib/interface/header.jsp"%>
				<!-- end: TOP NAVBAR -->
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						<iframe id="ifLinkPage" class="app-content container-fluid container-fullw bg-white" style="display: none; width: 100%; height: 100%; padding: 4px;">
						</iframe>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<p class="text-small">
												To add students, you need to be signed in as the super user.
											</p>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<p class="text-small">
												The Manage transactions tool provides a view of all your transaction.
											</p>
											<p class="cl-effect-1">
												<a href>
													view more
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<p class="text-small">
												Add, modify, class information from your system.
											</p>
											<p class="links cl-effect-1">
												<a href>
													view more
			...
			<!-- start: FOOTER -->
			<%@ include file="/jsplib/interface/footer.jsp"%>
			<!-- end: FOOTER -->
			<!-- start: OFF-SIDEBAR -->
		...
		<script src="${pageContext.request.contextPath}/school_reources/vendor/Chart.js/Chart.min.js"></script>
		<script src="${pageContext.request.contextPath}/school_reources/vendor/jquery.sparkline/jquery.sparkline.min.js"></script>
		<!-- end: JAVASCRIPTS REQUIRED FOR THIS PAGE ONLY -->
		<!-- start: CLIP-TWO JAVASCRIPTS -->
		<script src="${pageContext.request.contextPath}/school_reources/assets/js/main.js"></script>
		<!-- start: JavaScript Event Handlers for this page -->
		<script src="${pageContext.request.contextPath}/school_reources/assets/js/index.js"></script>
		<script>
...
<center>
	...
	<div id="main">
		...
		<%@ include file="/jsplib/interface/sidebar.jsp"%> 
		<!--end sidebar-->
			
		 <div id="content" style="margin-left:0px;">
			<div>
				<img src="${pageContext.request.contextPath}/assets/interface/images/center_banner.gif" alt="center Banner"/>
			</div>
			<div id="news"> 
				<h3>Latest Updates <a href="${pageContext.request.contextPath}/news/list.gw?menuCd=035" > &nbsp; More >></a></h3>
				<br/>
				<%
					SysNewsManager sysNewsManager=new SysNewsManager(request);
					List<NewsVO> lstNews = sysNewsManager.lstNewsVo();
					for(int i=0; i< lstNews.size(); i++){
						%>
							<h4><%=lstNews.get(i).getTitle() %> <small style="float:right;"><%=lstNews.get(i).getCrtDt() %></small></h4> 
							<p><%=lstNews.get(i).getContent() %>
								<a href="${pageContext.request.contextPath}/news/view/<%=lstNews.get(i).getPk() %>.gw?command=view&menuCd=035"> Read More</a>
							</p>
						<%						
					}
				%>
