		...
		<form>
			<table>
				<tr>
					...
					<td style="width: 75%" colspan="2"><input type="text"
						id="useId"></td>
				</tr>
				<tr>
					<td style="width: 25%"><label for="pass">Password</label></td>
					<td style="width: 75%" colspan="2"><input type="password"
						id="pass"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="width: 35%"><img id="captcha_image" src="${pageContext.request.contextPath}/simpleCaptcha.png" alt="capture" style="width: 95px; border-color: rgb(189, 210, 244);
  border-style: inset;
  border-width: 1px;">
						</td>
					<td style="width: 40%"><a href="javascript:void(0);"
						onclick="reloadCaptcha();"><i class="fa fa-refresh"></i></a>
						&nbsp; <a href="javascript:void(0);" onclick="checkCaptchaCode();"><i
							class="fa fa-sign-in">&nbsp;<br />Login
						</i></a></td>
				</tr>
			</table>
		</form>
		...
		$(document).ready(function(){
			...
			function reloadCaptcha() {
				...
				$("#captcha_image").attr("src",
						"${pageContext.request.contextPath}/simpleCaptcha.png");
			}
			function checkCaptchaCode() {
				...
				$
						.ajax({
							url : "${pageContext.request.contextPath}/captchavalid.gw",
							dataType : 'json',
							method : 'GET',
							data : datastring,
							beforeSend : function() {
								...
								if (data.status == 'success'
									...
									$
											.ajax({
												...
												success : function(data) {
													window.location = '${pageContext.request.contextPath}/index.gw';
												}
											});
								} else {
		...
		<%} else {%>
			<table>
				...
				<tr>
					<td style="width: 25%"><label for="captext"> </label>
					</td>
					<td style="width: 75%" colspan="2"></td>
				</tr>
				<tr>
					<td style="width: 25%">
						<a href="<%=request.getContextPath()%>/user/profile.gw?menuCd=032&command=write"><i class="fa fa-user">&nbsp;Profile</i></a>
					</td>
					<td style="width: 35%"></td>
					<td style="width: 40%">
						<a href="<%=request.getContextPath()%>/logout.gw" >
						<i
							class="fa fa-sign-out">&nbsp;Sign out</i>
							</a>
					</td>
				</tr>
			</table>
