<div id="HeaderDiv">
		<div style="float: right;">
			Welcome <a href="http://docs.castleproject.org/Language.aspx"
				class="systemlink" title="Select your language"><%=(request.getSession(false)==null)?"GUEST":request.getSession(false).getAttribute("CurrLoginInfo_UserName")	%></a>
		 <!-- , you are
