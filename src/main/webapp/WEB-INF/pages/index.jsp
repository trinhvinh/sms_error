...
<head>
	...
	<!-- start: MAIN CSS -->
	<link rel="stylesheet" media="screen" href="${pageContext.request.contextPath}/resources/core-sms/vendor/bootstrap/css/bootstrap.min.css">
	<link rel="stylesheet" media="screen" href="${pageContext.request.contextPath}/resources/core-sms/vendor/animate.css/animate.min.css">
	<link rel="stylesheet" media="screen" href="${pageContext.request.contextPath}/resources/core-sms/vendor/themify-icons/themify-icons.min.css">
	...
	<!-- start: CLIP-TWO CSS -->
	<link rel="stylesheet" media="screen" href="${pageContext.request.contextPath}/resources/core-sms/assets/css/styles.css">
	<link rel="stylesheet" media="screen" href="${pageContext.request.contextPath}/resources/core-sms/assets/css/plugins.css">
	<link rel="stylesheet" media="screen" href="${pageContext.request.contextPath}/resources/core-sms/assets/css/themes/theme-1.css" id="skin_color" />
	<!-- end: CLIP-TWO CSS -->
				...
				<section id="page-title" class="padding-top-15 padding-bottom-15">
					<div class="row">
						...
						<div class="col-sm-5">
							...
							</ul><!-- end: MINI STATS WITH SPARKLINE -->
						</div>
					</div>
				</section>
				<!-- end: DASHBOARD TITLE -->
						...
						<div class="col-sm-4">
							<div class="panel panel-white no-radius text-center">
								<div class="panel-body">
									...
									<h2 class="StepTitle"> Manage Transactions </h2>
						...
						<div class="col-sm-4">
							<div class="panel panel-white no-radius text-center">
								<div class="panel-body">
									...
									<h2 class="StepTitle">Manage Classes</h2>
							...
							<div class="panel panel-white no-radius">
								...
								<div class="panel-body no-padding">
									<div class="padding-10">
										<img width="50" height="50" src="/resources/core-sms/assets/images/avatar-1.jpg" class="img-circle pull-left" alt="">
											...
											<div id="users_followers" class="tab-pane padding-bottom-5 active">
												<div class="panel-scroll height-200">
													<table class="table no-margin">
														<tbody>
															<tr>
																<td class="center"><img alt="image" class="img-circle" src="/resources/core-sms/assets/images/avatar-1-small.jpg"></td>
															...
															<tr>
																<td class="center"><img alt="image" class="img-circle" src="/resources/core-sms/assets/images/avatar-2-small.jpg"></td>
															...
															<tr>
																<td class="center"><img alt="image" class="img-circle" src="/resources/core-sms/assets/images/avatar-3-small.jpg"></td>
															...
															<tr>
																<td class="center"><img alt="image" class="img-circle" src="/resources/core-sms/assets/images/avatar-5-small.jpg"></td>
															...
															<tr>
																<td class="center"><img alt="image" class="img-circle" src="/resources/core-sms/assets/images/avatar-4-small.jpg"></td>
												...
												<div class="panel-scroll height-200">
													<table class="table no-margin">
														<tbody>
															<tr>
																<td class="center">
																	<img alt="image" class="img-circle" src="/resources/core-sms/assets/images/avatar-3-small.jpg">
																</td>
																<td>
																	<span class="text-small block text-light">Visual Designer</span><span>Steven Thompson</span>
																</td>
																<td class="center">
																<div class="cl-effect-13">
																	<a href> view more </a>
															...
															<tr>
																<td class="center">
																	<img alt="image" class="img-circle" src="/resources/core-sms/assets/images/avatar-5-small.jpg">
																</td>
																<td>
																	<span class="text-small block text-light">Senior Designer</span><span>Kenneth Ross</span>
																</td>
																<td class="center">
																<div class="cl-effect-13">
																	<a href> view more </a>
															...
															<tr>
																<td class="center">
																	<img alt="image" class="img-circle" src="/resources/core-sms/assets/images/avatar-4-small.jpg">
																</td>
																<td>
